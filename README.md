...
I recently bought a ViewPlus device by AirThings to monitor the quality of my flat air: the device measures temperature, CO2, VOC, humidity and the data is available in a web dashboard or a smartphone app.
